...
// Функции для работы с мемными товарами
...
function openProduct(id) {
    // Переход на страницу товара с ID
...
function getProductData(id) {
    const products = {
        1: {
            title: "Запрещенный батончик Контрабандный Snickers",
            price: "666 ₽",
            description: "Официально запрещен к продаже в 47 странах мира! Этот батончик содержит недозволенные ингредиенты, которые делают его невероятно вкусным и вызывающим привыкание.",
            image: "product1.png"
        },
        2: {
            title: "Mega Chips Ультра Кетчуп",
            price: "420 ₽",
            description: "Чипсы с запрещенным вкусом ультра кетчуп. Вызывают привыкание с первого раза!",
            image: "product2.png"
        },
        3: {
            title: "Super Soda Нулевой Закон",
            price: "999 ₽",
            description: "Газировка с запрещенной формулой. Даже кола ревнует!",
            image: "product3.png"
        }
    };
